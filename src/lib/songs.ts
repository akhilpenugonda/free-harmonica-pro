...
export const SONGS: Song[] = [
  ...
  },
  {
    ...
    description:
      "Colter Wall's haunting cowboy ballad. This first-position C arrangement captures the signature harmonica intro and solo lines. Requested by the community.",
    bpm: 96,
    tabs: [
      { hole: 7, action: "blow" },
      { hole: 6, action: "draw" },
      ...
      { hole: 6, action: "draw" },
      { hole: 6, action: "blow" },
      { hole: 5, action: "blow", duration: 2 },
    ],
    tabSheet: [
      {
        label: "Intro",
        lines: [{ tabs: "7 -6 6 -6 6 -6 6 5 (45)" }],
      },
      {
        label: "Solo",
        lines: [
          { tabs: "(456) 7 -6 6 -6 6 -6 6 5 (45)" },
          { tabs: "7 -6 6 -6 7 -6 6 5" },
          { tabs: "7 -6 6 -6 7 -6 6 5" },
          { tabs: "5 6 -6 7 -6 6 -6 7 -6 6 5" },
          { tabs: "7 -6 6 -6 7 -6 6 5 (45)" },
        ],
      },
    ],
  },
